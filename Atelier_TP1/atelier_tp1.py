...
lbp = cv2.imread(
    "D:\\Documents\\Code\\atelier_creatif_tp\\Atelier_TP1\\lbp.png")
...
def mouse_click(event, x, y, flags, param):
    ...
    if event == cv2.EVENT_LBUTTONDOWN:
        ...
        if crop_img.shape != (64, 64):
            console.print(
                ":warning: Selected Area isn't 64x64 image, Please select a correct zone :warning:", style="red on white")
        else:
